    ...
    >
      ...
      <div className="mx-auto w-[1024px] max-w-full">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:mt-16 lg:grid-cols-3">
          {schoolsTodayCopy.cases.map((item) => (
            <article
              className="paper-card flex flex-col rounded-[20px] border border-black/5 bg-white p-6 shadow-[0_10px_60px_-30px_rgb(15_23_42/0.18)] sm:p-8"
              key={item.number}
            >
