 ...
 * the lush-hill hero backdrop, and the hand-drawn sketch overlays.
 *
 ...
 *     hero stage throughout the morph zone.
 *   - Inner backdrop motion.div (absolute inset-0) carries `opacity` +
 *     the hero visuals (hill bg + sketches). This is the layer that
 *     fades during the wow plateau.
